...
test("getSymbolFromCurrency(): valid params", (t) => {
  t.equal(
    ...
    "should return $ when USD is provided"
  );
  t.equal(
    "£",
    getSymbolFromCurrency("GBP"),
    "should return £ when GBP is provided"
  );
  t.equal(
    "€",
    getSymbolFromCurrency("EUR"),
    "should return € when EUR is provided"
  );
  t.equal(
    "€",
    getSymbolFromCurrency("eur"),
...
test("getSymbolFromCurrency(): invalid params", (t) => {
  ...
  t.equal(
    undefined,
    getSymbolFromCurrency(null),
    "should return undefined when param is null"
  );
  t.equal(
    undefined,
    getSymbolFromCurrency(false),
    "should return undefined when param is false"
  );
  t.equal(
    undefined,
    getSymbolFromCurrency(),
    "should return undefined when param is undefined"
  );
  t.end();
});
